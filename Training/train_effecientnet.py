...
def process(path):
        ...
        baseModel = EfficientNetB0(weights="imagenet", include_top=False, input_shape=(128,128, 3))
    ...
    Dense(5, activation="sigmoid") ])
        ...
        plt.savefig('results/Resnet_Training and validation accuracy.png') 
        plt.pause(5)
